...
private:
    ...
    QString uidCarte;    // UID du badge RFID pour le pointage
    ...
    // Champs pour la reconnaissance faciale
    bool visageEnregistre;
    QDate dateEnregistrementVisage;
...
public:
    ...
    QString getUidCarte() const { return uidCarte; }
    ...
    bool getVisageEnregistre() const { return visageEnregistre; }
    QDate getDateEnregistrementVisage() const { return dateEnregistrementVisage; }
    ...
    void setUidCarte(const QString &value) { uidCarte = value; }
    ...
    void setVisageEnregistre(bool value) { visageEnregistre = value; }
    void setDateEnregistrementVisage(const QDate &value) { dateEnregistrementVisage = value; }
