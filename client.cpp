...
bool Client::ajouter()
{
    ...
    // ÔöÇÔöÇ R├®cup├¿re le prochain id client ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    QSqlQuery seqQuery;
    if (!seqQuery.exec("SELECT SEQ_CLIENTS.NEXTVAL FROM DUAL")) {
        qDebug() << "[Client::ajouter] Erreur s├®quence :"
    ...
    // ÔöÇÔöÇ INSERT CLIENT ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    query.prepare(
        "INSERT INTO Clients "
    ...
    // ÔöÇÔöÇ INSERT HISTORIQUE ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    QSqlQuery histQuery;
...
bool Client::modifier()
{
    ...
    // ÔöÇÔöÇ 1. R├®cup├®rer ancien email ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    QString oldEmail;
    QSqlQuery getOld;
    ...
    // ÔöÇÔöÇ 2. UPDATE CLIENT ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    query.prepare(
        "UPDATE Clients SET "
        "nom              = :nom, "
        "prenom           = :prenom, "
    ...
    // ÔöÇÔöÇ 3. Si email chang├® ÔåÆ update historique ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    if (oldEmail != email) {
