...
void ClientManagerDialog::setupAddEditUI()
{
    ...
    prenomEdit->setPlaceholderText("Pr├®nom");
...
void ClientManagerDialog::setupExportUI()
{
    ...
    QGroupBox *colGroup = new QGroupBox("Colonnes ├á exporter", this);
    QHBoxLayout *colLayout = new QHBoxLayout(colGroup);

    chkNom = new QCheckBox("Nom", colGroup); chkNom->setChecked(true);
    chkPrenom = new QCheckBox("Pr├®nom", colGroup); chkPrenom->setChecked(true);
    ...
    QGroupBox *scopeGroup = new QGroupBox("P├®rim├¿tre", this);
    QHBoxLayout *scopeLayout = new QHBoxLayout(scopeGroup);

    radioAll = new QRadioButton("Tous", scopeGroup);
    radioAll->setChecked(true);
    radioSelected = new QRadioButton("S├®lectionn├®s", scopeGroup);
    radioFiltered = new QRadioButton("Filtr├®s", scopeGroup);
