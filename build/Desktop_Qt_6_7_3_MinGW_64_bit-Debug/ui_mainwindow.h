...
public:
    ...
    QLabel *profileValue_2;
    QLabel *profileLabel_3;
    QLabel *profileValue_3;
    QLabel *profileLabel_4;
    QLabel *profileValue_4;
    QLabel *profileLabel_5;
    QLabel *profileValue_5;
    QLabel *profileLabel_6;
    QLabel *profileValue_6;
    QLabel *profileLabel_7;
    QLabel *profileValue_7;
    QLabel *profileLabel_8;
    QLabel *profileValue_8;
    QLabel *profileLabel_9;
    QLabel *profileValue_9;
    QLabel *profileLabel_10;
    QLabel *profileValue_10;
    QLabel *profileLabel_11;
    QLabel *profileValue_11;
    QLabel *profileLabel_12;
    QLabel *profileValue_12;
    QLabel *profileLabel_13;
    QLabel *profileValue_13;
...
"   "));
        ...
        btnAIChat = new QPushButton(sidebar);
        btnAIChat->setObjectName("btnAIChat");
        btnAIChat->setMinimumSize(QSize(0, 50));
        btnAIChat->setStyleSheet(QString::fromUtf8("QPushButton {\n"
...
"QPushButton:hover { background-color: #4E342E; }"));
        ...
        verticalLayout_2->addWidget(btnAIChat);
        ...
        searchBox = new QLineEdit(toolbarWidget);
        searchBox->setObjectName("searchBox");
        searchBox->setMinimumSize(QSize(200, 0));
        ...
        employeeTable = new QTableWidget(employeePage);
        ...
        verticalLayout_3->addWidget(employeeTable);
...
""));
        ...
        btnAIAgent = new QPushButton(clientButtonsWidget);
        btnAIAgent->setObjectName("btnAIAgent");
        btnAIAgent->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"  background-color: #8D6E63;\n"
"  color: white;\n"
"  border: none;\n"
"  border-radius: 10px;\n"
...
""));
        ...
        horizontalLayout_6->addWidget(btnAIAgent);

        btnExportClient = new QPushButton(clientButtonsWidget);
        btnExportClient->setObjectName("btnExportClient");
        btnExportClient->setMinimumSize(QSize(85, 32));

        horizontalLayout_6->addWidget(btnExportClient);
        ...
        if (fournisseurTable->columnCount() < 8)
            fournisseurTable->setColumnCount(8);
        ...
        sendEmailButton = new QPushButton(productionToolbar);
...
""));
        ...
        horizontalLayout_production->addWidget(sendEmailButton);
        ...
        if (productionTable->columnCount() < 10)
            productionTable->setColumnCount(10);
        QTableWidgetItem *__qtablewidgetitem32 = new QTableWidgetItem();
        productionTable->setHorizontalHeaderItem(0, __qtablewidgetitem32);
        QTableWidgetItem *__qtablewidgetitem33 = new QTableWidgetItem();
        productionTable->setHorizontalHeaderItem(1, __qtablewidgetitem33);
        QTableWidgetItem *__qtablewidgetitem34 = new QTableWidgetItem();
        productionTable->setHorizontalHeaderItem(2, __qtablewidgetitem34);
        QTableWidgetItem *__qtablewidgetitem35 = new QTableWidgetItem();
        productionTable->setHorizontalHeaderItem(3, __qtablewidgetitem35);
        QTableWidgetItem *__qtablewidgetitem36 = new QTableWidgetItem();
        productionTable->setHorizontalHeaderItem(4, __qtablewidgetitem36);
        QTableWidgetItem *__qtablewidgetitem37 = new QTableWidgetItem();
        productionTable->setHorizontalHeaderItem(5, __qtablewidgetitem37);
        QTableWidgetItem *__qtablewidgetitem38 = new QTableWidgetItem();
        productionTable->setHorizontalHeaderItem(6, __qtablewidgetitem38);
        QTableWidgetItem *__qtablewidgetitem39 = new QTableWidgetItem();
        productionTable->setHorizontalHeaderItem(7, __qtablewidgetitem39);
        QTableWidgetItem *__qtablewidgetitem40 = new QTableWidgetItem();
        productionTable->setHorizontalHeaderItem(8, __qtablewidgetitem40);
        QTableWidgetItem *__qtablewidgetitem41 = new QTableWidgetItem();
        productionTable->setHorizontalHeaderItem(9, __qtablewidgetitem41);
        ...
        articleTable->setHorizontalHeaderItem(0, __qtablewidgetitem42);
        QTableWidgetItem *__qtablewidgetitem43 = new QTableWidgetItem();
        articleTable->setHorizontalHeaderItem(1, __qtablewidgetitem43);
        QTableWidgetItem *__qtablewidgetitem44 = new QTableWidgetItem();
        articleTable->setHorizontalHeaderItem(2, __qtablewidgetitem44);
        QTableWidgetItem *__qtablewidgetitem45 = new QTableWidgetItem();
        articleTable->setHorizontalHeaderItem(3, __qtablewidgetitem45);
        QTableWidgetItem *__qtablewidgetitem46 = new QTableWidgetItem();
        articleTable->setHorizontalHeaderItem(4, __qtablewidgetitem46);
        QTableWidgetItem *__qtablewidgetitem47 = new QTableWidgetItem();
        articleTable->setHorizontalHeaderItem(5, __qtablewidgetitem47);
        QTableWidgetItem *__qtablewidgetitem48 = new QTableWidgetItem();
        articleTable->setHorizontalHeaderItem(6, __qtablewidgetitem48);
        QTableWidgetItem *__qtablewidgetitem49 = new QTableWidgetItem();
        articleTable->setHorizontalHeaderItem(7, __qtablewidgetitem49);
        QTableWidgetItem *__qtablewidgetitem50 = new QTableWidgetItem();
        articleTable->setHorizontalHeaderItem(8, __qtablewidgetitem50);
        QTableWidgetItem *__qtablewidgetitem51 = new QTableWidgetItem();
        articleTable->setHorizontalHeaderItem(9, __qtablewidgetitem51);
        QTableWidgetItem *__qtablewidgetitem52 = new QTableWidgetItem();
        articleTable->setHorizontalHeaderItem(10, __qtablewidgetitem52);
        ...
        profilePanel = new QFrame(contentArea);
        profilePanel->setObjectName("profilePanel");
        profilePanel->setMinimumSize(QSize(260, 0));
        profilePanel->setMaximumSize(QSize(260, 16777215));
        profilePanel->setFrameShape(QFrame::Shape::StyledPanel);
        verticalLayout_7 = new QVBoxLayout(profilePanel);
        verticalLayout_7->setSpacing(15);
        verticalLayout_7->setObjectName("verticalLayout_7");
        verticalLayout_7->setContentsMargins(20, 20, 20, 20);
        profileTitle = new QLabel(profilePanel);
        profileTitle->setObjectName("profileTitle");
        profileTitle->setAlignment(Qt::AlignmentFlag::AlignCenter);

        verticalLayout_7->addWidget(profileTitle);

        photoPlaceholder = new QLabel(profilePanel);
        photoPlaceholder->setObjectName("photoPlaceholder");
        photoPlaceholder->setEnabled(true);
        photoPlaceholder->setMinimumSize(QSize(120, 120));
        photoPlaceholder->setMaximumSize(QSize(120, 120));
        photoPlaceholder->setAlignment(Qt::AlignmentFlag::AlignCenter);

        verticalLayout_7->addWidget(photoPlaceholder, 0, Qt::AlignmentFlag::AlignHCenter);

        line = new QFrame(profilePanel);
        ...
        infoSection = new QWidget(profilePanel);
        infoSection->setObjectName("infoSection");
        formLayout = new QFormLayout(infoSection);
        formLayout->setObjectName("formLayout");
        formLayout->setHorizontalSpacing(10);
        formLayout->setVerticalSpacing(10);
        profileLabel = new QLabel(infoSection);
        profileLabel->setObjectName("profileLabel");

        formLayout->setWidget(0, QFormLayout::LabelRole, profileLabel);

        profileValue = new QLabel(infoSection);
        profileValue->setObjectName("profileValue");

        formLayout->setWidget(0, QFormLayout::FieldRole, profileValue);

        profileLabel_2 = new QLabel(infoSection);
        profileLabel_2->setObjectName("profileLabel_2");

        formLayout->setWidget(1, QFormLayout::LabelRole, profileLabel_2);

        profileValue_2 = new QLabel(infoSection);
        profileValue_2->setObjectName("profileValue_2");

        formLayout->setWidget(1, QFormLayout::FieldRole, profileValue_2);

        profileLabel_3 = new QLabel(infoSection);
        profileLabel_3->setObjectName("profileLabel_3");

        formLayout->setWidget(2, QFormLayout::LabelRole, profileLabel_3);

        profileValue_3 = new QLabel(infoSection);
        profileValue_3->setObjectName("profileValue_3");

        formLayout->setWidget(2, QFormLayout::FieldRole, profileValue_3);

        profileLabel_4 = new QLabel(infoSection);
        profileLabel_4->setObjectName("profileLabel_4");

        formLayout->setWidget(3, QFormLayout::LabelRole, profileLabel_4);

        profileValue_4 = new QLabel(infoSection);
        profileValue_4->setObjectName("profileValue_4");

        formLayout->setWidget(3, QFormLayout::FieldRole, profileValue_4);

        profileLabel_5 = new QLabel(infoSection);
        profileLabel_5->setObjectName("profileLabel_5");

        formLayout->setWidget(4, QFormLayout::LabelRole, profileLabel_5);

        profileValue_5 = new QLabel(infoSection);
        profileValue_5->setObjectName("profileValue_5");

        formLayout->setWidget(4, QFormLayout::FieldRole, profileValue_5);

        profileLabel_6 = new QLabel(infoSection);
        profileLabel_6->setObjectName("profileLabel_6");

        formLayout->setWidget(5, QFormLayout::LabelRole, profileLabel_6);

        profileValue_6 = new QLabel(infoSection);
        profileValue_6->setObjectName("profileValue_6");

        formLayout->setWidget(5, QFormLayout::FieldRole, profileValue_6);

        profileLabel_7 = new QLabel(infoSection);
        profileLabel_7->setObjectName("profileLabel_7");

        formLayout->setWidget(6, QFormLayout::LabelRole, profileLabel_7);

        profileValue_7 = new QLabel(infoSection);
        profileValue_7->setObjectName("profileValue_7");

        formLayout->setWidget(6, QFormLayout::FieldRole, profileValue_7);

        profileLabel_8 = new QLabel(infoSection);
        profileLabel_8->setObjectName("profileLabel_8");

        formLayout->setWidget(7, QFormLayout::LabelRole, profileLabel_8);

        profileValue_8 = new QLabel(infoSection);
        profileValue_8->setObjectName("profileValue_8");

        formLayout->setWidget(7, QFormLayout::FieldRole, profileValue_8);

        profileLabel_9 = new QLabel(infoSection);
        profileLabel_9->setObjectName("profileLabel_9");

        formLayout->setWidget(8, QFormLayout::LabelRole, profileLabel_9);

        profileValue_9 = new QLabel(infoSection);
        profileValue_9->setObjectName("profileValue_9");

        formLayout->setWidget(8, QFormLayout::FieldRole, profileValue_9);

        profileLabel_10 = new QLabel(infoSection);
        profileLabel_10->setObjectName("profileLabel_10");

        formLayout->setWidget(9, QFormLayout::LabelRole, profileLabel_10);

        profileValue_10 = new QLabel(infoSection);
        profileValue_10->setObjectName("profileValue_10");

        formLayout->setWidget(9, QFormLayout::FieldRole, profileValue_10);

        profileLabel_11 = new QLabel(infoSection);
        profileLabel_11->setObjectName("profileLabel_11");

        formLayout->setWidget(10, QFormLayout::LabelRole, profileLabel_11);

        profileValue_11 = new QLabel(infoSection);
        profileValue_11->setObjectName("profileValue_11");

        formLayout->setWidget(10, QFormLayout::FieldRole, profileValue_11);

        profileLabel_12 = new QLabel(infoSection);
        profileLabel_12->setObjectName("profileLabel_12");

        formLayout->setWidget(11, QFormLayout::LabelRole, profileLabel_12);

        profileValue_12 = new QLabel(infoSection);
        profileValue_12->setObjectName("profileValue_12");

        formLayout->setWidget(11, QFormLayout::FieldRole, profileValue_12);

        profileLabel_13 = new QLabel(infoSection);
        profileLabel_13->setObjectName("profileLabel_13");

        formLayout->setWidget(12, QFormLayout::LabelRole, profileLabel_13);

        profileValue_13 = new QLabel(infoSection);
        profileValue_13->setObjectName("profileValue_13");

        formLayout->setWidget(12, QFormLayout::FieldRole, profileValue_13);


        verticalLayout_7->addWidget(infoSection);
        ...
        horizontalLayout_3->addWidget(profilePanel);
...
"Management", nullptr));
        ...
        btnAIChat->setText(QCoreApplication::translate("MainWindow", " \360\237\244\226 Assistant IA", nullptr));
        moduleTitle->setText(QCoreApplication::translate("MainWindow", "GESTION DES EMPLOYEES", nullptr));
        statsLabel->setText(QCoreApplication::translate("MainWindow", " Employees Totale ", nullptr));
        statsValue->setText(QCoreApplication::translate("MainWindow", "247", nullptr));
        statsLabel_2->setText(QCoreApplication::translate("MainWindow", "Active", nullptr));
        statsValue_2->setText(QCoreApplication::translate("MainWindow", "238", nullptr));
        statsLabel_3->setText(QCoreApplication::translate("MainWindow", "Departments", nullptr));
        statsValue_3->setText(QCoreApplication::translate("MainWindow", "12", nullptr));
        searchBox->setPlaceholderText(QCoreApplication::translate("MainWindow", "\342\214\225 Rechercher des employees...", nullptr));
        ...
        btnExport->setText(QCoreApplication::translate("MainWindow", "\342\207\251 Export", nullptr));
        ...
        btnAIAgent->setText(QCoreApplication::translate("MainWindow", "\342\237\201 Agent IA", nullptr));
        btnExportClient->setText(QCoreApplication::translate("MainWindow", "\342\207\251 Export", nullptr));
        ...
        sendEmailButton->setText(QCoreApplication::translate("MainWindow", "Confirmer", nullptr));
        ...
        QTableWidgetItem *___qtablewidgetitem32 = productionTable->horizontalHeaderItem(0);
        ___qtablewidgetitem32->setText(QCoreApplication::translate("MainWindow", "ID", nullptr));
        QTableWidgetItem *___qtablewidgetitem33 = productionTable->horizontalHeaderItem(1);
        ___qtablewidgetitem33->setText(QCoreApplication::translate("MainWindow", "R\303\211F\303\211RENCE", nullptr));
        QTableWidgetItem *___qtablewidgetitem34 = productionTable->horizontalHeaderItem(2);
        ___qtablewidgetitem34->setText(QCoreApplication::translate("MainWindow", "EMPLOY\303\211", nullptr));
        QTableWidgetItem *___qtablewidgetitem35 = productionTable->horizontalHeaderItem(3);
        ___qtablewidgetitem35->setText(QCoreApplication::translate("MainWindow", "PRODUIT", nullptr));
        QTableWidgetItem *___qtablewidgetitem36 = productionTable->horizontalHeaderItem(4);
        ___qtablewidgetitem36->setText(QCoreApplication::translate("MainWindow", "MONTANT HT", nullptr));
        QTableWidgetItem *___qtablewidgetitem37 = productionTable->horizontalHeaderItem(5);
        ___qtablewidgetitem37->setText(QCoreApplication::translate("MainWindow", "DATE CR\303\211ATION", nullptr));
        QTableWidgetItem *___qtablewidgetitem38 = productionTable->horizontalHeaderItem(6);
        ___qtablewidgetitem38->setText(QCoreApplication::translate("MainWindow", "DATE LIVRAISON", nullptr));
        QTableWidgetItem *___qtablewidgetitem39 = productionTable->horizontalHeaderItem(7);
        ___qtablewidgetitem39->setText(QCoreApplication::translate("MainWindow", "STATUT", nullptr));
        QTableWidgetItem *___qtablewidgetitem40 = productionTable->horizontalHeaderItem(8);
        ___qtablewidgetitem40->setText(QCoreApplication::translate("MainWindow", "PRIORIT\303\211", nullptr));
        QTableWidgetItem *___qtablewidgetitem41 = productionTable->horizontalHeaderItem(9);
        ___qtablewidgetitem41->setText(QCoreApplication::translate("MainWindow", "MAIL CLIENT", nullptr));
        ...
        ___qtablewidgetitem43->setText(QCoreApplication::translate("MainWindow", "R\303\211F\303\211RENCE", nullptr));
        QTableWidgetItem *___qtablewidgetitem44 = articleTable->horizontalHeaderItem(2);
        ___qtablewidgetitem44->setText(QCoreApplication::translate("MainWindow", "NOM", nullptr));
        QTableWidgetItem *___qtablewidgetitem45 = articleTable->horizontalHeaderItem(3);
        ___qtablewidgetitem45->setText(QCoreApplication::translate("MainWindow", "CAT\303\211GORIE", nullptr));
        QTableWidgetItem *___qtablewidgetitem46 = articleTable->horizontalHeaderItem(4);
        ___qtablewidgetitem46->setText(QCoreApplication::translate("MainWindow", "TYPE", nullptr));
        QTableWidgetItem *___qtablewidgetitem47 = articleTable->horizontalHeaderItem(5);
        ___qtablewidgetitem47->setText(QCoreApplication::translate("MainWindow", "COULEUR", nullptr));
        QTableWidgetItem *___qtablewidgetitem48 = articleTable->horizontalHeaderItem(6);
        ___qtablewidgetitem48->setText(QCoreApplication::translate("MainWindow", "DIMENSIONS", nullptr));
        QTableWidgetItem *___qtablewidgetitem49 = articleTable->horizontalHeaderItem(7);
        ___qtablewidgetitem49->setText(QCoreApplication::translate("MainWindow", "PRIX UNITAIRE", nullptr));
        QTableWidgetItem *___qtablewidgetitem50 = articleTable->horizontalHeaderItem(8);
        ___qtablewidgetitem50->setText(QCoreApplication::translate("MainWindow", "CO\303\233T FABRICATION", nullptr));
        QTableWidgetItem *___qtablewidgetitem51 = articleTable->horizontalHeaderItem(9);
        ___qtablewidgetitem51->setText(QCoreApplication::translate("MainWindow", "STATUT", nullptr));
        QTableWidgetItem *___qtablewidgetitem52 = articleTable->horizontalHeaderItem(10);
        ___qtablewidgetitem52->setText(QCoreApplication::translate("MainWindow", "DATE CR\303\211ATION", nullptr));
        profileTitle->setText(QCoreApplication::translate("MainWindow", "Employee Profile", nullptr));
        photoPlaceholder->setText(QCoreApplication::translate("MainWindow", "\342\227\217", nullptr));
        profileLabel->setText(QCoreApplication::translate("MainWindow", "Matricule:", nullptr));
        profileValue->setText(QCoreApplication::translate("MainWindow", "EMP-2024-001", nullptr));
        profileLabel_2->setText(QCoreApplication::translate("MainWindow", "Nom:", nullptr));
        profileValue_2->setText(QCoreApplication::translate("MainWindow", "Benali", nullptr));
        profileLabel_3->setText(QCoreApplication::translate("MainWindow", "Prenom:", nullptr));
        profileValue_3->setText(QCoreApplication::translate("MainWindow", "Ahmed", nullptr));
        profileLabel_4->setText(QCoreApplication::translate("MainWindow", "CIN:", nullptr));
        profileValue_4->setText(QCoreApplication::translate("MainWindow", "AB123456", nullptr));
        profileLabel_5->setText(QCoreApplication::translate("MainWindow", "Date Naissance:", nullptr));
        profileValue_5->setText(QCoreApplication::translate("MainWindow", "15/03/1985", nullptr));
        profileLabel_6->setText(QCoreApplication::translate("MainWindow", "Sexe:", nullptr));
        profileValue_6->setText(QCoreApplication::translate("MainWindow", "M", nullptr));
        profileLabel_7->setText(QCoreApplication::translate("MainWindow", "Adresse:", nullptr));
        profileValue_7->setText(QCoreApplication::translate("MainWindow", "Casablanca", nullptr));
        profileLabel_8->setText(QCoreApplication::translate("MainWindow", "Telephone:", nullptr));
        profileValue_8->setText(QCoreApplication::translate("MainWindow", "0612345678", nullptr));
        profileLabel_9->setText(QCoreApplication::translate("MainWindow", "Email:", nullptr));
        profileValue_9->setText(QCoreApplication::translate("MainWindow", "a.benali@cuirea.com", nullptr));
        profileLabel_10->setText(QCoreApplication::translate("MainWindow", "Poste:", nullptr));
        profileValue_10->setText(QCoreApplication::translate("MainWindow", "Supervisor", nullptr));
        profileLabel_11->setText(QCoreApplication::translate("MainWindow", "Specialite:", nullptr));
        profileValue_11->setText(QCoreApplication::translate("MainWindow", "Production", nullptr));
        profileLabel_12->setText(QCoreApplication::translate("MainWindow", "Departement:", nullptr));
        profileValue_12->setText(QCoreApplication::translate("MainWindow", "Production", nullptr));
        profileLabel_13->setText(QCoreApplication::translate("MainWindow", "Date Embauche:", nullptr));
        profileValue_13->setText(QCoreApplication::translate("MainWindow", "01/01/2024", nullptr));
    } // retranslateUi
