QT       += core gui charts printsupport sql network multimedia multimediawidgets serialport
QT += charts
...
SOURCES += \
    ...
    pointage.cpp \
    pointagedialog.cpp \
    pythonfacerecognition.cpp \
    simplefacecapture.cpp
